...
RSpec.describe Accounts::Create::EmbededCompanySite, type: :request do
  describe 'success' do
    ...
    let(:account) { create(:account, site_url: 'https://docs.krauffcrm.com/docs/intro') }
    ...
    it 'embeded company site' do
      stub_request(:get, 'https://docs.krauffcrm.com/docs/intro')
        .to_return(status: 200, body: File.read('spec/integration/use_cases/accounts/create/mock_docs_site/intro.html'))
      stub_request(:get, 'https://docs.krauffcrm.com/docs/%23__docusaurus_skipToContent_fallback')
      ...
      stub_request(:get, 'https://docs.krauffcrm.com/docs/Developer%20Guides/Self%20hosted/deploy')
